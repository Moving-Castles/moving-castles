...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("AbilityPlay"))));
uint256 constant AbilityPlayTableId = _tableId;
...
library AbilityPlay {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AbilityPlay", _fieldNames);
  }
