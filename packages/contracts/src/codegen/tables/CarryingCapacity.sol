...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("CarryingCapacity"))));
uint256 constant CarryingCapacityTableId = _tableId;

library CarryingCapacity {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CarryingCapacity", _fieldNames);
  }
