...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("Commit"))));
uint256 constant CommitTableId = _tableId;
