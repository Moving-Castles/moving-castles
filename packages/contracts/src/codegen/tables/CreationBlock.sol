...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("CreationBlock"))));
uint256 constant CreationBlockTableId = _tableId;

library CreationBlock {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CreationBlock", _fieldNames);
  }
