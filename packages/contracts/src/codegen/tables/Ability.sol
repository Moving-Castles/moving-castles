...
library Ability {
  ...
  /** Get value */
  function get(bytes32 _tableId, bytes32 key) internal view returns (bool value) {
  ...
  function get(IStore _store, bytes32 _tableId, bytes32 key) internal view returns (bool value) {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32((key));
  ...
  /** Set value */
  function set(bytes32 _tableId, bytes32 key, bool value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32((key));
  ...
  function set(IStore _store, bytes32 _tableId, bytes32 key, bool value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32((key));
