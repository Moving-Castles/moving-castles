...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("AbilityMove"))));
uint256 constant AbilityMoveTableId = _tableId;
...
library AbilityMove {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AbilityMove", _fieldNames);
  }
