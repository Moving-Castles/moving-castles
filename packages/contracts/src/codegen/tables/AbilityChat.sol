...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("AbilityChat"))));
uint256 constant AbilityChatTableId = _tableId;
...
library AbilityChat {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AbilityChat", _fieldNames);
  }
