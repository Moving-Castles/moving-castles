...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("AbilityConsume"))));
uint256 constant AbilityConsumeTableId = _tableId;

library AbilityConsume {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AbilityConsume", _fieldNames);
  }
