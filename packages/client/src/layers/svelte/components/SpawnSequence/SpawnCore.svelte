...
<div class="spawn-sequence" in:fade>
  {#if $playerCore && counter > 20}
    <img draggable="false" src={$staticContent.cores[idToAvatarIndex($playerAddress)].w800} alt="core" />
    ...
    >
  {:else}
    <img draggable="false" src={$staticContent.cores[coreIndex].w400} alt="core" />
  {/if}
</div>
